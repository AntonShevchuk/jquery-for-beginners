...
{% hint style="info" %}
Если по какой-то причине вы ещё не знакомы с `data()`, советую перечитать главу [Data-атрибуты ](../20\_attributes\_and\_properties/data-attributes.md)и ознакомиться с [официальной документацией](https://api.jquery.com/data/).
{% endhint %}
