...
Офіційна документація по бібліотеці Sizzle доступна на [GitHub'і проєкту](https://github.com/jquery/sizzle/wiki/).
