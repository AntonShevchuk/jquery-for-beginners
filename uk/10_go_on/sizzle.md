...
Таким чином, розглядаючи вираз `div#my`, Sizzle знайде спочатку елемент з `id="my"`, а потім уже перевірить на відповідність з `<div>`. Добре, це наче як фільтрація, і вона теж дотримується черговості – це другий нюанс:
