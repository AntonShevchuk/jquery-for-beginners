...
> Є ще один пункт – обирати найшвидший селектор з можливих, але тут без доброго багажу знань не обійтися, тож наважитися, пробуйте та надсилайте ваші приклади.
...
> Цей тест виконує пошук елементів кількома способами та був спочатку розроблений Іллею Кантором для майстер-класу з JavaScript та jQuery
