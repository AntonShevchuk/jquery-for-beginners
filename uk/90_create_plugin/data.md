...
{% hint style="info" %}
Якщо з якоїсь причини ви ще не знайомі з `data()`, раджу перечитати главу [Data-атрибути ](../20\_attributes\_and\_properties/data-attributes.md)та ознайомитися з [офіційною документацією](https://api.jquery.com/data/).
{% endhint %}
