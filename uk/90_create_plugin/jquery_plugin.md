...
Для розуміння цього шматочка коду тобі треба розібратися лише зі змінною `arguments` та методом `apply()`. Тут їм цілі статті присвятили, дерзай:
