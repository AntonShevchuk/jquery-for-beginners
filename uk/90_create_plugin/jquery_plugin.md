...
Для початку давайте згадаємо, для чого нам потрібні плагіни? Моя відповідь — для створення повторно використовуваного коду, причому зі зручним інтерфейсом. Давайте напишемо такий код, почнемо з простого завдання:
...
Якщо ваш плагін навішує який-небудь обробник, то найкраще (читайте – завжди) цей обробник навісити у своєму власному namespace:
