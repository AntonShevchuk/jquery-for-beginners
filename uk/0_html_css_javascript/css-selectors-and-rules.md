...
Це приклад простого й правильного HTML з невеличким додаванням CSS. Розберімо селектори в наведеному CSS-коді (я навмисно не виносив CSS в окремий файл, бо так наочніше):
...
3. найважливіші для нас — стилі автора сторінки, але й тут усе йде за порядком
   *   найнижчий пріоритет у стилів, що підключені як файл `<link rel="stylesheet" type="text/css" href="...">` або вбудовані всередину HTML за допомогою тегу `<style>`:
       ...
       > і звісно, при рівності пріоритетів «капці» у того, хто оголошений останнім
