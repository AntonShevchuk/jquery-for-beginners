...
Я не наполягаю на своєму варіанті, але хотілось би, щоб ви взяли на озброєння один із багатьох стандартів форматування і завжди слідували йому.

> Коли станете матьорим front-end розробником — пізнаєте всю силу CSS-препроцесорів, а поки слухайте і запам'ятовуйте.
