...
{% hint style="warning" %}
Це задачка по юзабіліті — ми завжди повинні тримати користувача сайту в курсі справи про те, що відбувається на сторінці і відправка AJAX-запиту теж потрапляє під розряд «must know». Подібне рішення у тебе буде практично на будь-якому сайті, де ходить AJAX.
{% endhint %}
...
$.ajax({
    ...
    complete: function() {
        // і по завершенні запиту (вдалому чи ні)
    }
});
```
