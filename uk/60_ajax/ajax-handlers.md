...
{% hint style="warning" %}
Це задачка з юзабіліті — ми завжди повинні тримати користувача сайту в курсі справи про те, що відбувається на сторінці і відправка AJAX-запиту теж потрапляє під розряд «must know». Подібне рішення у вас буде практично на будь-якому сайті, де ходить AJAX.
{% endhint %}
