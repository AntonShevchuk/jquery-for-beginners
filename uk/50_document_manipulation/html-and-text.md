...
Ну і трохи про вміст елементів, для роботи з ним у нас є 2 методи: `html()` та `text()`, між ними одна суттєва різниця — перший вміє отримувати та вставляти HTML код, другий же завжди оперує текстом. Навіть якщо ти спробуєш згодувати йому HTML, в результаті отримаєш текст, де теги будуть приведені до [HTML entities](https://ru.wikipedia.org/wiki/%D0%9C%D0%BD%D0%B5%D0%BC%D0%BE%D0%BD%D0%B8%D0%BA%D0%B8\_%D0%B2\_HTML):
...
</code></pre></td><td>повертає текст заданого елемента;<br>якщо всередині елемента будуть інші HTML-теги, то повернеться збірна солянка з тексту всіх елементів</td></tr><tr><td><pre class="language-javascript"><code class="lang-javascript">text(newText)
