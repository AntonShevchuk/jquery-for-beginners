...
Для клонування елемента є метод `clone()`, він створить для вас клон елемента, і ви зможете його вставити в DOM використовуючи будь-який з [відповідних методів](manipulation.md).

Мало того, якщо у вас там були обробники подій, то їх також можна клонувати, достатньо лише виставити перший аргумент в `true`:
...
</code></pre></td><td>клонує на додаток обробники подій та дані дочірніх елементів</td></tr></tbody></table>

Окрім клонування, ви можете вилучити з DOM будь-який елемент, щоб змінити та вставити назад, або маєте право навіть видалити його:
