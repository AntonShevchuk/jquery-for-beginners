...
Методів реально багато, я й сам не завжди пам'ятаю що і для чого (особливо це стосується wrap-сімейства), тож не обтяжуй себе запам'ятовуванням усього перерахованого, головне пам'ятати, що такі є, і тримати під рукою [документацію](https://api.jquery.com/category/manipulation/).
