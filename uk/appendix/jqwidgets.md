...
{% hint style="warning" %}
Цей фреймворк безкоштовний лише частково, у нього звісно є [Community ліцензія](https://www.jqwidgets.com/license/), але фактично тобі таки треба буде розкошелитися, якщо тобі потрібні будуть віджети.
{% endhint %}
