...
[jQWidgets](https://www.jqwidgets.com/) – це не просто бібліотека, а цілий комбайн з купою корисних віджетів. Їх на даний момент налічується понад 60 штук, тож тільки навести список і скріншот на кожен – вже півкниги буде. Тому обійдемося коротеньким резюме до кількох віджетів, сподіваюся цього вистачить, щоб у вас розігрався апетит, і ви зважилися б подивитися на сайт розробників.
...
{% hint style="warning" %}
Цей фреймворк безкоштовний лише частково, у нього звісно є [Community ліцензія](https://www.jqwidgets.com/license/), але фактично вам таки треба буде розкошелитися, якщо вам потрібні будуть віджети.
{% endhint %}
