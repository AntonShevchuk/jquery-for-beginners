...
Перш ніж приступити до прочитання цього розділу, варто визначитися, що ж таке події web-сторінки. Отже, події – це будь-які дії користувача, будь то введення даних з клавіатури, прокручування сторінки чи рухи мишки, і, звичайно ж, «кліки».
