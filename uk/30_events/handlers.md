...
Для роботи з подіями існує три основні методи:
...
Запустіть код вище у [пісочниці](https://anton.shevchuk.name/book/code/sandbox.html), і спробуйте клацнути по параграфу.
...
Хоча я ще хотів згадати один важливий момент — усередині обробника ви можете отримати доступ до DOM-елемента, використовуючи ключове слово `this`. Якщо ж треба буде скористатися jQuery-інструментами, то використовуйте конструкцію `$(this)`:
