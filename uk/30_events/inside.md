...
Ми вже встигли познайомитися з shorthand-методом `click()`. Насправді, цей метод являє собою лише обгортку для виклику `on()` та `trigger()`:
...
Всередині самого jQuery :) Якщо ви хочете отримати всі обробники подій, то вам знадобиться наступний метод:
