...
{% hint style="info" %}
Але перш ніж продовжити, рекомендую освіжити в пам'яті інформацію про [обчислення висоти та ширини блокових елементів](../0_html_css_javascript/advanced-css.md#size) ;)
{% endhint %}
