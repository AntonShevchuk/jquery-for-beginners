...
У [попередньому розділі](../10_go_on/be-ready.md) ми вже стикалися з методом `.css()`, з його допомогою ми змінювали колір шрифту, але на цьому його можливості не закінчуються. Час копнути глибше, щоб не штурмувати форуми банальними питаннями ;)
