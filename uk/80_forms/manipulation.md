...
> Можна, звісно, використовувати й метод `click()`, щоб емулювати вибір необхідного пункту, але це викличе всі обробники події «`click`», що небажано.
...
Перевіряти й відправляти форму через AJAX тепер уміємо, залишилося вирішити питання з динамічною зміною форми. І для цього в нас уже є всі необхідні знання. Ось, наприклад, додавання списку, що випадає:
