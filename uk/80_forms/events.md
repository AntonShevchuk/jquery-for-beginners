...
<table data-header-hidden><thead><tr><th width="262">подія</th><th>опис</th></tr></thead><tbody><tr><td><code>change</code></td><td>зміна значення елемента</td></tr><tr><td><code>submit</code></td><td>відправлення форми</td></tr></tbody></table>
...
Відстеження `submit` необхідно для перевірки правильності заповнення всіх полів форми, а також для відправлення форми за допомогою AJAX.
...
При повторному відправленні форми не забудьте прибрати повідомлення, що залишилися від попередньої перевірки:
...
Я хотів ще повернутися до списку подій форми та перелічити ті, що бракують:
