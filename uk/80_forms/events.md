...
При повторній відправці форми не забудь прибрати повідомлення, що залишилися від попередньої перевірки:
...
Попередній приклад вже додано на сторінку [form.basic.html](https://anton.shevchuk.name/book/code/form.basic.html), спробуй відправити форму; запит та відповідь, що вийшли, зможеш вивчити в консолі браузера:
