...
Навіщо я постійно звертаю твою увагу на зміни в таких старих версіях jQuery? Просто ніхто не знає з чим тобі доведеться зіткнутися, тому краще готуватися до гіршого.
{% endhint %}

В яких випадках нам це буде корисно? Ну якщо тобі потрібно відстежувати прогрес анімації, то це саме те, що тобі потрібно, точніше, тобі потрібна буде функція `progress(animation, progress, remainingMs)`:
