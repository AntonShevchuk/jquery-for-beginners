...
Для демонстрации работы данного «надуманного» варианта откройте «песочницу», запустите приведённый код и, открыв web-консоль разработчика, кликните мышкой по элементам:
