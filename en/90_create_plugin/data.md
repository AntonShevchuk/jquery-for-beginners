...
{% hint style="info" %}
If for some reason you're not yet familiar with `data()`, I recommend re-reading the [Data Attributes](../20_attributes_and_properties/data-attributes.md) chapter and checking out the [official documentation](https://api.jquery.com/data/).
{% endhint %}
