...
{% hint style="info" %}
I should remember to tell you about `obj[jQuery.expando] = uuid` and `jQuery._data(element)`, and also about [memory leaks](https://learn.javascript.ru/memory-leaks-jquery), but probably not today.
{% endhint %}
