...
Удалены shorthand-методы для следующих событий: `load()`, `unload()` и `error()`; связано данное изменение с конфликтами, возникающими при использовании данных методов, так что переписывайте на `on()`:
