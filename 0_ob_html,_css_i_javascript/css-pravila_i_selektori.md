...
* самые важные — стили автора странички, но и там всё идёт по порядку:
    ...
    *   между двух правил с меткой «!important» приоритетность снова определяется происхождением (мета-тег, тег `<style>`, хардкод)
...
Это пример простого и правильного HTML 5 с небольшим добавлением CSS 3. Давайте разберём селекторы в приведённом CSS-коде
